...
node 'jenkins.local' {   
 ...
 jenkins::plugin { 'git-client': version => 'latest', } 
 jenkins::plugin { 'token-macro': version => 'latest', }
 jenkins::plugin { 'jackson2-api': version => 'latest', }
 jenkins::plugin { 'plain-credentials': version => 'latest', }
 jenkins::plugin { 'matrix-project': version => 'latest', }
 jenkins::plugin { 'scm-api': version => 'latest', }
 jenkins::plugin { 'workflow-step-api': version => 'latest', }
 jenkins::plugin { 'script-security': version => 'latest', }
 jenkins::plugin { 'workflow-api': version => 'latest', }
 jenkins::plugin { 'mailer': version => 'latest', }
 jenkins::plugin { 'ssh-credentials': version => 'latest', }
 jenkins::plugin { 'apache-httpcomponents-client-4-api': version => 'latest', }
 jenkins::plugin { 'junit': version => 'latest', }
 jenkins::plugin { 'jsch': version => 'latest', }
 jenkins::plugin { 'javadoc': version => 'latest', }
 jenkins::plugin { 'maven-plugin':  version => 'latest', }
 jenkins::plugin { 'github': version => 'latest', }
